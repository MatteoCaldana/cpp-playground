...
std::array<std::array<uint,9>,27> Sudoku::_group{{{0,1,2,3,4,5,6,7,8},
...
constexpr std::array<std::array<uint,24>,81> Sudoku::_neighbors{{{1,2,3,4,5,6,7,8,9,18,27,36,45,54,63,72,1,2,9,10,11,18,19,20},
...
constexpr std::array<std::array<uint,3>,81> Sudoku::_groups_of{{{0,9,18},
                                             {0,10,18},
                                             {0,11,18},
                                             {0,12,19},
                                             {0,13,19},
